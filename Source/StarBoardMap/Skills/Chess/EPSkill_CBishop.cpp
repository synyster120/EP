...
#include "Skills/Chess/EPSkill_CBishop.h"
...
void UEPSkill_CBishop::Activate(ACharacter* Caster, const FEPSkillTargetData& NewTargetData, int32 CurrentComboIndex)
{
...
void UEPSkill_CBishop::Explode(ACharacter* Caster, int32 Count)
{
